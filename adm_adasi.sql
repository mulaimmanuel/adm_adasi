...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2024 at 01:33 AM
...
CREATE TABLE `detail_preventives` (
  ...
  `perbaikan_checked` int(11) DEFAULT NULL,
...
INSERT INTO `detail_preventives` (`id`, `id_mesin`, `issue`, `issue_checked`, `perbaikan`, `perbaikan_checked`, `created_at`, `updated_at`) VALUES
(240, 31, NULL, NULL, '12314', 0, '2024-03-05 01:25:06', '2024-03-05 01:25:06');
...
(1, 'ASA', '2024-03-04 08:10:07', '2024-03-04 08:10:07', '2024-03-04 08:14:29', '2024-03-04 08:14:29');
...
(108, 'FP0108', 'Rina Suryani', '2024-03-09', 'Bubut', 'CC1', 'DS8', 'd', NULL, '1', '2024-03-01 02:40:35', '2024-03-05 01:06:06'),
...
(2, 'WO/2024/002223', 4, 3, '14', '12', '12', '89', NULL, '12', '10', 'Retak', 'HeatTreatment', 'Complain', NULL, '2H9TzmC4QB4kQmUXx03ygnV4BHnrc2EVMwq7zRdI.png', 3, '2024-02-26 15:15:39', '2024-02-26 15:23:15');
...
(28, 'Mesin Cutting 5', 'CC3', 'Honda', 'Honda', '2010', '2024', 14, NULL, 0, 'public/assets/foto/s8kJfctIkT7orUX5Y0ptPB9hABk1f6kqnD2osFBF.jpg', 'public/assets/sparepart/lKhJkLFaomAxnWxqllPIZohPVLeEerP3kzitFBoZ.jpg', '2024-02-15 06:52:22', '2024-02-27 07:12:58'),
...
(30, 'Mesin Cutting 7', 'CC3', 'Honda', 'Honda', '2010', '2024', 14, NULL, 0, 'assets/foto/gunung.jpg', 'assets/sparepart/gunung.jpg', '2024-02-15 09:57:10', '2024-02-27 07:11:12'),
(31, 'Mesin Cutting 8', 'CC3', 'Honda', 'Honda', '2010', '2024', 14, NULL, 0, 'assets/foto/Mesin baru.jpg', 'assets/sparepart/Mesin baru.jpg', '2024-02-15 09:58:15', '2024-02-27 07:26:32');
...
CREATE TABLE `preventives` (
  ...
  `rencana_perbaikan` varchar(50) DEFAULT NULL,
...
INSERT INTO `preventives` (`id`, `id_mesin`, `nama_mesin`, `no_mesin`, `type`, `mfg_date`, `issue`, `rencana_perbaikan`, `status`, `created_at`, `updated_at`) VALUES
(1, 23, 'Mesin Cutting Baru', 'CC003', 'Yamaha', '1988', 'Sparepart Rusak', 'Ganti Sparepart', '0', '2024-02-27 01:16:35', '2024-02-27 01:16:35'),
(2, 24, 'Mesin Machinig Custom', 'CC003', 'Honda', '2000', 'Part ada yang rusak', 'Ganti dan perbaiki part', '0', '2024-02-27 01:16:35', '2024-02-27 01:16:35');
...
(2, 1, '2024-02-28', 'Hasil visit material memang harus di klaim karena genjang pada sisi X', '2024-02-29', 'Rodjo dan Eto-sang', 'C7j661ikRtyZ7KCTOTblNQqCX6sgZeN2zm3sWH87.pdf', 3, '2024-02-26 04:57:21', '2024-02-26 04:57:21'),
(3, 2, '2024-02-26', NULL, '2024-02-26', 'Pak rojo', NULL, 1, '2024-02-26 15:16:30', '2024-02-26 15:16:30'),
(4, 2, '2024-02-28', 'Adanya kerusakan retak pada barang', '2024-03-02', 'Pak rojo & Eto', 'YSRRFzb9tfvt3hzjxVTUF1DiiLjWRW3MONCHOtKj.pdf', 1, '2024-02-26 15:20:31', '2024-02-26 15:20:31'),
(5, 2, '2024-02-26', 'Adanya Kerusakan pada barang ', '2024-02-26', 'Pak rojo & Eto', NULL, 3, '2024-02-26 15:20:40', '2024-02-26 15:20:40');
...
--
-- Table structure for table `tindaklanjuts`
--

CREATE TABLE `tindaklanjuts` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `id_fpp` varchar(255) NOT NULL,
  `tindak_lanjut` date NOT NULL,
  `due_date` date NOT NULL,
  `schedule_pengecekan` date NOT NULL,
...
--
-- Indexes for table `detail_preventives`
--
...
--
-- Indexes for table `tindaklanjuts`
--
ALTER TABLE `tindaklanjuts`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `detail_preventives`
--
ALTER TABLE `detail_preventives`
...
--
-- AUTO_INCREMENT for table `tindaklanjuts`
--
ALTER TABLE `tindaklanjuts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
